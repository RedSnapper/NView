...
class UriTest extends \PHPUnit_Framework_TestCase {
	...
	public function setup() {
		$this->s = new Services();
		$this->s->addRule('*', ['shared'=>true,'inherit'=>true]);
//new NViewLogger('Log');
		$this->s->addRule('NViewLogger', ['instance'=> function() {return $this->createMock('NViewLogger'); }]);

		$this->s->addRule('LoggerInterface', ['instanceOf'=>'NViewLogger']);


//		$this->s->addRule('Uri', ['substitutions' => ['LoggerInterface' => ['instance' => function() {return new NViewLogger();}]]]);
...
//		$this->z = $this->getMockBuilder('NViewLogger')->setMockClassName('MViewLogger')->getMock();

		$this->s->addRule('EnvServer',['instance'=>function() {return $this->createMock('EnvServer');}]);
//		$this->s->addRule('NViewLogger', ['instance'=>function() {return NViewLogger();}]);
//		$this->s->addRule('LoggerInterface', ['instanceOf'=>'NViewLogger']);
		$this->s->addRule('UriInterface', ['instanceOf'=>"Uri"]);

//		$this->s->addRule('Uri',['substitutions'=>['LoggerInterface'=>['instance'=>function() {return NViewLogger();}]]]);
